                  ...
                  <div class="carousel-inner">
                    <div class="container">
                      <div class="carousel-caption fadeInUp animated" style="bottom:0;top:200px">
                        ...
                        <p class="h2" style="color: #ddd;padding-top:20px;padding-bottom: 20px">A Restaurant by Anjani</p>
                      </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <ul>
                        <li style="padding-left: 50px;margin-bottom: 10px">
                            ...
                            Jalan Raya Jambu, <br> Malang, Jawa Timur
                        </li>
                        <li style="padding-left: 50px;margin-bottom: 10px"><i class="icon-phone" style="position: absolute;left: 20px"></i> (0341)456-789</li>
